...
public class ConstructionDevisITTest {
    ...
    private EvenementDTO evenementDTOMock;

    @Test
    public void test() throws IOException, DocumentException {
        this.evenementDTOMock = new EvenementDTO();
        this.evenementDTOMock.setId(100L);
        this.evenementDTOMock.setNom("TEST");
        this.evenementDTOMock.setForfaitDplct(100);
        this.evenementDTOMock.setForfaitMo(250);
        ...
        compositionDTOMock.setPrixUnitaire(25);
        ...
        compositionDTOMock1.setPrixUnitaire(75);
        ...
        compositionDTOMock2.setPrixUnitaire(750);
        ...
        this.evenementDTOMock.setCompositions(compositionDTOSMock);
        this.constructionDevis.manipulatePdf(this.evenementDTOMock);
    }
}
